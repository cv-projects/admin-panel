...
const CreateCategory = () => {
    ...
    const {productCategories, singleProductCategory,handleUpdateProductCategory} = useProductStateContext();
    ...
    useEffect(() => {
        setId(singleProductCategory.id);
        setTitle(singleProductCategory.title);
        setParent(singleProductCategory.parent);
        setStatus(singleProductCategory.status);
    }, []);

    const handleUpdateCategory = (event) => {
        event.preventDefault();
        const catData = {id,title, parent, status};
        handleUpdateProductCategory(catData)
    }
